...
EFRport = r'COM7'
#OVport = r'COM16'
header0 = "OV OFF Time,OV OFF GGvolt,OV OFF GGcurrent,Vsysmin,OV OFF Vsysavg, OV OFF IspkrmaX, OV OFF IspkrAVG, \n"
...
#EFR.setRTS(True)
LOG0 = r'C:\Users\EIzazaga\OneDrive - Arlo Technologies, Inc\Desktop\Aquila Stuff\SpeakerDroopTest\SpeakerDroop_testCode\TestLogs\DRY_RUN_LOG0.txt'
...
if __name__=="__main__":
    ...
    #counter that will call the ttModuleLogInISP()
    #every ~30 minutes
    ...
    while(VsysMinGlobal > 2.8 and VsysAvgGlobal > 3.0 ):
        ...
        #print("ISP COUNTER FOR RELOGIN: "+ str(ISPCounterForLogin))
        #if(ISPCounterForLogin == 13):
        #    ttModuleLogInISP()
        #loginISP()
        #GG to log1
        #scope cap to log1
        ...
        #    ISPCounterForLogin = 0
        #else:
        #    ISPCounterForLogin = ISPCounterForLogin + 1
